...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Создание экземпляров для сохранения игровой статистики и панели результатов
    ...
    def _create_alien(self, alien_number, row_number):
        # Создание пришельца и расположение его в ряду
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Создание нового флота и расположение корабля по центру
            self._create_fleet()
            self.ship.center_ship()

            # Указка мышки прячется
    ...
    def _update_aliens(self):
        """Обновляет позиции всех пришельцев с флота"""
        ...
        # Проверить досягли ли пришельцы нижнего края
        self._check_aliens_bottom()

    def _check_aliens_bottom(self):
        """Проверяет досягли ли пришельцы края экрана"""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Очищение списков пришельцев и снарядов
            self.aliens.empty()
            self.bullets.empty()

            # Создание нового флота и размещения корабля по центру
            self._create_fleet()
            self.ship.center_ship()
